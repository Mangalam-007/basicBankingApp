...
class impoAdapter:RecyclerView.Adapter<impoAdapter.CustomViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        val currentItem = accountList[position]
            ...
            holder.itemView.list_row.setOnClickListener {
                val action = AllCustomersFragmentDirections.actionAllCustomersFragmentToAccountHolderParentFragment(currentItem)
